...
export const Login: React.FC<LoginProps> = ({ onLogin, companyLogo, users }) => {
  ...
  // Helper: Normalización agresiva (Nuclea cualquier espacio, tabulación o salto de línea)
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    if (user) {
      ...
      // Diagnóstico específico para el error (mantenemos el mensaje detallado aunque quitamos la lista visual)
      ...
      if (!emailExists) {
        ...
        setError('Correo encontrado, pero la CONTRASEÑA es incorrecta.');
      }
    }
  };
